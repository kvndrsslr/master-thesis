...
While there has been a lot of work\todo{cite} on the automatic linkage and fusion, RDF Dataset Enrichment has been paid little attention to, despite there being a critical need for better solutions in order to truly enable  Semantic Web powered applications.
...
Finally, we conclude in \autoref{ch:conclusion}.\todo{Extend this}
